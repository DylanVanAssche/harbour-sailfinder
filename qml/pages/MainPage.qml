    ...
    SilicaFlickable {
        ...
        Column {
            ...
            SlideshowView {
                ...
                itemWidth: width
                model: photosPeople
                visible: !pageStack.busy && !matched_message.open && !message.enabled
            ...
            Item {
                ...
                visible: !matched_message.open && !message.enabled
                ...
                Row {
                    ...
                    IconButton {
                        icon.source: {
                            if (Screen.width < widthScreenLimit)
                            {
                    ...
                    IconButton {
                        ...
                        enabled: buttonsEnabled && !superLikeLimit
                        onClicked:
                        {
                            buttonsEnabled = false;
            ...
            Label {
                ...
                visible: !matched_message.open && !message.enabled && bio.length
            ...
            Item {
                ...
                visible: !matched_message.open && !message.enabled && school.length && school_enabled
            ...
            Item {
                ...
                visible: !matched_message.open && !message.enabled && job.length && job_enabled
            ...
            Item {
                ...
                visible: !matched_message.open && !message.enabled && instagram_username.length && instagram_enabled
                        ...
                        Image {
                            ...
                            onStatusChanged:
                            {
                                ...
                                else if (status == Image.Error)
                                {
                                    ...
                                    photosInstagram.remove(photosInstagramCount+1)
                                }
                                else
                                {
                                    progressIndicator2.running = false
        ...
        Python {
            ...
            Component.onCompleted:
            {
                ...
                // Ask for our recommendations as soon as Python is ready
                python.call('api.recommendations',[], function() {});
